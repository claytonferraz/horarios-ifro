  ...
  ({
    ...
    useEffect(() => {
      if (
        ...
        (!activeCourseTab || !profCourses.includes(activeCourseTab))
      ) {
        setActiveCourseTab(profCourses[0]);
      }
        ...
        <div className={`w-full space-y-6`}>
          {profCourses.length === 0 ? (
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              {(() => {
                const course = activeCourseTab || profCourses[0];
